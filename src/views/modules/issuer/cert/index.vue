<template>
  <div>
    ...
    <el-table ref="singleTable" :data="dataList" border @current-change="handleCurrentChange"
      ...
      <el-table-column prop="issueTime" label="发证时间" min-width="100"></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getDataList() {
        this.isIssuer();
        let result = this.$apis.$issuer.getCertList(this.dataForm.certStatus, this.dataForm.searchKey, this.pageIndex, this.pageSize);
        if (result) {
